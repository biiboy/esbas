...
@section('content')
    ...
    <div class="tw-pb-6 tw-bg-gradient-to-r tw-from-{{ session('business.theme_color') ?? 'primary' }}-800 tw-to-{{ session('business.theme_color') ?? 'primary' }}-900 xl:tw-pb-0 ">
                        ...
                        <div class="tw-transition-all lg:tw-col-span-2 xl:tw-col-span-2 tw-duration-200 tw-bg-white tw-shadow-sm tw-rounded-xl tw-ring-1 hover:tw-shadow-md hover:tw--translate-y-0.5 tw-ring-gray-200">
                            <div class="tw-p-4 sm:tw-p-5">
                                <div class="tw-flex tw-items-center tw-gap-2.5">
                                    ...
                                    {{-- <div class="tw-mt-2 sm:tw-w-1/3 md:tw-w-1/4 tw-ml-auto">
                                        @if (count($all_locations) > 1)
                                            <form method="GET" action="{{ url()->current() }}">
                                                {!! Form::select('select_chart_1', $all_locations, null, [
                                                    'class' => 'form-control select2',
                                                    'placeholder' => __('lang_v1.select_location'),
                                                    'id' => 'select_chart_1',
