...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/reports/produk-kurang-laku', [ReportController::class, 'getProdukKurangLaku']);
    Route::get('/reports/produk-tidak-bergerak', [ReportController::class, 'getProdukTidakBergerak']);
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::get('/purchases/validasi/{id}', [PurchaseController::class, 'validasi']);
