        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($attendance)
                ...
                ->editColumn('clock_in', function ($row) {
                    ...
                    if (!empty($row->clock_in_latitude) && !empty($row->clock_in_longitude)) {
                        $html .= '<button data-lat="' . $row->clock_in_latitude . '" data-lng="' . $row->clock_in_longitude . '" class="btn btn-xs btn-info btn-location" data-toggle="modal" data-target="#location_attendance_modal">
                ...
                ->editColumn('clock_out', function ($row) {
                    ...
                    if (!empty($row->clock_out_latitude) && !empty($row->clock_out_longitude)) {
                        $html .= '<button data-lat="' . $row->clock_out_latitude . '" data-lng="' . $row->clock_out_longitude . '" class="btn btn-xs btn-info btn-location" data-toggle="modal" data-target="#location_attendance_modal">
                                    <i class="fas fa-map-marker-alt"></i> Location
                                  </button><br>';
                    }
        ...
        try {
            ...
            if ($type == 'clock_in') {
                $data = [
                    ...
                    'clock_in_latitude' => $request->input('clock_in_out_latitude'),
                    'clock_in_longitude' => $request->input('clock_in_out_longitude'),
                ];
                ...
                $data = [
                    ...
                    'clock_out_latitude' => $request->input('clock_in_out_latitude'),
                    'clock_out_longitude' => $request->input('clock_in_out_longitude'),
                ];
