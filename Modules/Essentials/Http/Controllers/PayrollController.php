    ...
    public function create()
    {
        ...
        if (! empty($add_payroll_for)) {
            ...
            foreach ($employees as $employee) {
                ...
                $payrolls[$employee->id]['telat_menit'] = $this->essentialsUtil->getTotalTelatMenit($employee->id, $business_id, $month, $year);
                $payrolls[$employee->id]['lembur_menit'] = $this->essentialsUtil->getTotalLemburMenit($employee->id, $business_id, $month, $year);
            ...
            return view('essentials::payroll.create')
                ->with(compact('month_name', 'transaction_date', 'year', 'payrolls', 'action', 'location', 'settings'));
        } else {
