...
class EssentialsSettingsController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        try {
            $input = $request->only(['leave_ref_no_prefix', 'leave_instructions', 'payroll_ref_no_prefix', 'payroll_potongan_telat', 'bonus_lembur', 'essentials_todos_prefix', 'grace_before_checkin', 'grace_after_checkin', 'grace_before_checkout', 'grace_after_checkout']);
