        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <input type="hidden" name="clock_in_out_latitude" id="clock_in_out_latitude" value="">
                    <input type="hidden" name="clock_in_out_longitude" id="clock_in_out_longitude" value="">
                </div>
