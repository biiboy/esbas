...
@php
    ...
    $jml_potongan_telat = !empty($settings['payroll_potongan_telat']) ? $settings['payroll_potongan_telat'] : 0;
    $jml_bonus_lembur = !empty($settings['bonus_lembur']) ? $settings['bonus_lembur'] : 0;
@endphp
                                                ...
                                                <tbody>
                                                    ...
                                                    @if (!empty($payroll['allowances']))
                                                        @foreach ($payroll['allowances']['allowance_names'] as $key => $value)
                                                            @include('essentials::payroll.allowance_and_deduction_row', ['add_button' => $loop->index == 0 ? true : false, 'type' => 'allowance', 'name' => $value, 'value' => $payroll['allowances']['allowance_amounts'][$key], 'amount_type' => $payroll['allowances']['allowance_types'][$key], 'percent' => $payroll['allowances']['allowance_percents'][$key]])
                                                        ...
                                                        @endforeach
                                                    @else
                                                        @if ($payroll['lembur_menit'] > 0)
                                                            @php $total_bonus = $jml_bonus_lembur * $payroll['lembur_menit']; @endphp
                                                            @include('essentials::payroll.allowance_and_deduction_row', ['add_button' => true, 'type' => 'allowance', 'name' => 'Lembur (' . $payroll['lembur_menit'] . ' menit)', 'value' => $total_bonus])
                                                        @else
                                                ...
                                                <tbody>
                                                    ...
                                                    @if (!empty($payroll['deductions']))
                                                        @foreach ($payroll['deductions']['deduction_names'] as $key => $value)
                                                            @include('essentials::payroll.allowance_and_deduction_row', ['add_button' => $loop->index == 0 ? true : false, 'type' => 'deduction', 'name' => $value, 'value' => $payroll['deductions']['deduction_amounts'][$key], 'amount_type' => $payroll['deductions']['deduction_types'][$key], 'percent' => $payroll['deductions']['deduction_percents'][$key]])
                                                        ...
                                                        @endforeach
                                                    @else
                                                        @if ($payroll['telat_menit'] > 0)
                                                            @php $total_potongan = $jml_potongan_telat * $payroll['telat_menit']; @endphp
                                                            @include('essentials::payroll.allowance_and_deduction_row', ['add_button' => true, 'type' => 'deduction', 'name' => 'Telat (' . $payroll['telat_menit'] . ' menit)', 'value' => $total_potongan])
                                                        @else
